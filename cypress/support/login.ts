...
declare namespace Cypress {
  interface Chainable {
    ...
    logInToMyOder(username?: string, password?: string): Chainable<null>;
...
Cypress.Commands.add("register", () => {
  ...
  cy.wait(1000);
  cy.logInToMyOder(GEN_EMAIL, GEN_PASSWORD);
})

Cypress.Commands.add("logInToMyOder", (username, password) => {
